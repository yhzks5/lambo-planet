...
/**
 * 代码生成类
 * Created by ZhangShulambo on 2017/4/26.
 */
public class Generator {

	// 根据命名规范，只修改此常量值即可
	private static String MODULE = "lambo-ucenter";
	private static String DATABASE = "lambo";
	private static String TABLE_PREFIX = "ucenter_";
	private static String PACKAGE_NAME = "com.lambo.ucenter";
